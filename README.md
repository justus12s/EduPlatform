...
<a href="<?=base_url()?><?=base_url()?><?=base_url()?>/https://github.com/codeigniter4/CodeIgniter4/graphs/contributors">
  <img src = "<?=base_url()?>/https://contrib.rocks/image?repo=codeigniter4/CodeIgniter4" />
</a>
...
>>>>>>> e6b8d597c5692dabfe1df84fb7cf974b4699424a
