            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form>
                  ...
                  <a href="<?= base_url() ?>./dashboard/index" class="btn btn-danger w-100 py-8 mb-4 rounded-2">Sign Up</a>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="mb-0 fw-bolder">Already have an Account?</p>
                    <a class="text-danger ms-2 font-14 fw-bolder" href="<?= base_url() ?>./dashboard/authentication_login">Sign In</a>
                  </div>
                </form>
              </div>
            </div>
