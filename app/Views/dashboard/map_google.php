...
<body>
            ...
            <div class="white-box">
              ...
              <div id="gmaps-simple" class="gmaps" style="position: relative; overflow: hidden">
                  ...
                  <div class="gm-style" style="
                    ...
                    <div style="
                      ...
                      <a target="_blank" rel="noopener"
                        href="<?= base_url() ?>https://maps.google.com/maps?ll=34.05,-78.72&amp;z=5&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                        title="Open this area in Google Maps (opens a new window)" style="
                            position: static;
                            overflow: visible;
                            float: none;
                            display: inline;
                        ...
                        <div style="width: 66px; height: 26px; cursor: pointer">
                          <img alt="" src="http://maps.gstatic.com/mapfiles/api-3/images/google4.png" draggable="false"
                            style="
                                position: absolute;
                                left: 0px;
                                top: 0px;
                    ...
                    <div style="
                      ...
                      <button draggable="false" title="Close" aria-label="Close" type="button"
                        class="gm-ui-hover-effect" style="
                            background: none;
                            display: block;
                            border: 0px;
                            margin: 0px;
                      ...
                      <div draggable="false" class="gm-style-cc" style="
                        ...
                        <div style="
                          ...
                          <a style="
                                ...
                                cursor: pointer;
                                display: none;
                              ">Map Data</a><span>Map data ©2021 Google, INEGI</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="gmnoprint gm-style-cc" draggable="false" style="
                      ...
                      <div style="
                            ...
                            display: inline-block;
                          ">
                        <a href="<?= base_url() ?>https://www.google.com/intl/en-US_US/help/terms_maps.html" target="_blank"
                          rel="noopener" style="
                              text-decoration: none;
                              cursor: pointer;
                              color: rgb(68, 68, 68);
                    ...
                    <button draggable="false" title="Toggle fullscreen view" aria-label="Toggle fullscreen view"
                      type="button" class="gm-control-active gm-fullscreen-control" style="
                    ...
                    <div draggable="false" class="gm-style-cc" style="
                      ...
                      <div style="
                        ...
                        <a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google"
                          href="<?= base_url() ?>https://www.google.com/maps/@34.05,-78.72,5z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
                          style="
                              font-family: Roboto, Arial, sans-serif;
                              font-size: 10px;
                              color: rgb(68, 68, 68);
                    ...
                    <div class="gmnoprint gm-bundled-control" draggable="false" controlwidth="40" controlheight="81"
                      style="
                          margin: 10px;
                          user-select: none;
                          position: absolute;
                    ...
                    <div class="
                        ...
                        " draggable="false" controlwidth="0" controlheight="0" style="
                          margin: 10px;
                          user-select: none;
                          position: absolute;
                          display: none;
                      ...
                      <div class="gmnoprint" controlwidth="40" controlheight="40"
                        ...
                        <div style="width: 40px; height: 40px">
                          <button draggable="false" title="Rotate map 90 degrees" aria-label="Rotate map 90 degrees"
                            type="button" class="gm-control-active" style="
                                background: none rgb(255, 255, 255);
                                display: none;
                                border: 0px;
                                margin: 0px 0px 32px;
                            ...
                            aria-label="Tilt map" type="button" class="gm-tilt gm-control-active" style="
                                background: none rgb(255, 255, 255);
                                display: block;
                                border: 0px;
                                margin: 0px;
                ...
                <div style="
                    ...
                    ">
                  <div>
                    <img alt="" src="http://maps.gstatic.com/mapfiles/api-3/images/google_gray.svg" draggable="false"
                      style="
                          padding: 0px;
                          margin: 0px;
                          border: 0px;
                  ...
                  <table style="width: 100%">
                    <tr>
                      <td style="line-height: 16px; vertical-align: middle">
                        <a href="<?= base_url() ?>https://developers.google.com/maps/documentation/javascript/error-messages?utm_source=maps_js&amp;utm_medium=degraded&amp;utm_campaign=keyless#api-key-and-billing-errors"
  ...
  <!-- google maps api -->
  <script src="<?= base_url() ?>http://maps.google.com/maps/api/js?sensor=true"></script>
  <script src="<?= base_url() ?>plugins/bower_components/gmaps/gmaps.min.js"></script>
  <script src="<?= base_url() ?>plugins/bower_components/gmaps/jquery.gmaps.js"></script>
  <!--Custom JavaScript -->
