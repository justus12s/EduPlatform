...
<div id="debug-bar">
    <div class="toolbar">
            ...
            <?php if (! $c['isEmpty'] && ($c['hasTabContent'] || $c['hasLabel'])) : ?>
                <span class="ci-label">
                    <a data-tab="ci-<?= $c['titleSafe'] ?>">
                        <img src="<?= base_url() ?><?= base_url() ?><?= base_url() ?>/<?= $c['icon'] ?>">
                        <span class="hide-sm">
                            <?= $c['title'] ?>
        ...
        <span class="ci-label">
            <a data-tab="ci-vars">
                <img src="<?= base_url() ?><?= base_url() ?><?= base_url() ?>/data:image/png;base64,">
